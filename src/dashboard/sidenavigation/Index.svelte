...
<aside use:clickOutside on:click_outside={closeSidenav} class={`pt-16 ${style.default} ${style.mobilePosition[mobilePosition]} ${$open ? style.open : style.close} scrollbar`}>

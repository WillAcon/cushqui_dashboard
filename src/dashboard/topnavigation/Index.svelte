...
<header class="h-20 items-center relative lg:z-111">
	<div
		class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex flex-center shadow-sm flex-col h-full justify-center mx-auto relative px-3 text-black dark:text-white z-10"
	>
		<div
		...
		>
			<div class="flex group h-full items-center relative w-12">
				...
				>
					{#if $open}
						<div
							class="p-2 bg-gray-700 dark:bg-gray-200 text-white dark:text-black rounded-full"
						>
							<IconSlider size="36" />
						</div>
					{:else}
			...
			>
				<span class="block pr-5 hidden lg:block">
					<button on:click={() => open_ew.update((value) => !value)}
						>Evento cookie</button
					>
				</span>

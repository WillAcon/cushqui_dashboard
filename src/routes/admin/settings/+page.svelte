		...
		<div class="row">
			<div class="col-md-6 offset-md-3 col-xs-12">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" value={data.user.first_name} name="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nombre" required>
                    </div>
                </div>
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Apellidos</label>
			...
			<div class="h-10"></div>
				...
				<form use:enhance method="POST" action="?/logout">
					<Button class="bg-orange-500" type="submit">Or click here to logout.</Button>
				</form>
			</div>
		</div>
	</div>

...
<div class="flex flex-wrap">
	<div class="w-full lg:w-8/12 c-800 dark:bg-gray-200 py-6 px-6 rounded-3xl">
		...
		<div class="flex flex-wrap justify-between items-center pb-8">
			<div class="flex flex-wrap text-white dark:text-black">
				<div class="pr-10">
	...
	<div class="w-full mt-8 lg:mt-0 lg:w-4/12 lg:pl-4">
		<div class="bg-gray-800 dark:bg-gray-200 rounded-3xl px-6 pt-6">
			<div class="flex text-white dark:text-black text-2xl pb-6 font-bold">
				<p>Client Messages</p>
			</div>
			<div>
				<div
